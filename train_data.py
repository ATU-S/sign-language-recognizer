...
def train_model(data_dir="sign_data", img_size=(128, 128), epochs=10, batch_size=32):
    """
    Trains a CNN model using the images and labels from the specified directory.
